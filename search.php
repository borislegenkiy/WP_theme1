...
get_header(); ?>
	<div class="container">
			...
			<div class="place_names_article">
					<div class="names_article f_left">
						<div class="name_article f_left"><a href="#">База знаний</a></div>
						<div class="space_article f_left">&nbsp;\&nbsp;</div>
						<div class="name_article f_left"><a href="#">Статьи</a></div>
					</div>
				</div>
				<? if (have_posts()) { ?>
				...
				<? } else {
					...
					echo "<h1>Введите, пожалуйста, другие данные</h1>";
				} ?>
			...
			<form class='widget2-subscribe-form' accept-charset='utf-8' action='http://e.lifeha.ru/add_contact_webform.html?u=QfBS' method='post' target='_blank'>							
					<table style="float: right;">
								<tr width="100%">
									...
									<td width="50%"><input class='podpis_input_button wf-button submit-template-lifeha widget2-subscribe-submit' type='submit' name='submit' value=''></td>
								</tr>
							</table>
